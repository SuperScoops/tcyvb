...
/*player skin*/
$('head').append("<link rel='stylesheet' href='//rawgit.com/SuperScoops/tcyvb/master/base.css' />");
$('head').append("<link rel='stylesheet' href='//rawgit.com/SuperScoops/tcyvb/master/polyzor.css' />");
...
$('<link id="chanfavicon" href="//i.imgur.com/IBQkZbg.png" type="image/x-icon" rel="shortcut icon" />')
.appendTo("head");});
